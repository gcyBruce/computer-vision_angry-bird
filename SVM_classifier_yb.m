% training set
imdsTrain = imageDatastore('./SVM/yellow_bird/training',...    
    'IncludeSubfolders',true,...    
    'LabelSource','foldernames');
imdsTest = imageDatastore('./SVM/yellow_bird/test');   
...
yb_classifer = fitcsvm(featuresTrain,trainLabels);   
