% training set
imdsTrain = imageDatastore('./SVM/black_bird/training',...    
    'IncludeSubfolders',true,...    
    'LabelSource','foldernames');
imdsTest = imageDatastore('./SVM/black_bird/test');   
...
black_classifer = fitcsvm(featuresTrain,trainLabels);   
...
% end    
save('black_svmModel','black_classifer');