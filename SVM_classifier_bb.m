% training set
imdsTrain = imageDatastore('./SVM/blue_bird/training',...    
    'IncludeSubfolders',true,...    
    'LabelSource','foldernames');
imdsTest = imageDatastore('./SVM/blue_bird/test');   
...
bb_classifer = fitcsvm(featuresTrain,trainLabels);   
