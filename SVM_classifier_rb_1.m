% training set
imdsTrain = imageDatastore('./SVM/red_bird/1/training',...    
    'IncludeSubfolders',true,...    
    'LabelSource','foldernames');
%imdsTest = imageDatastore('./SVM/yellow_bird/1/test');   
...
rb_classifer = fitcsvm(featuresTrain,trainLabels);   
...
% end    
save('rb_svmModel_1','rb_classifer');
