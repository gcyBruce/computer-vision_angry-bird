% training set
imdsTrain = imageDatastore('./SVM/slingshot/training',...    
    'IncludeSubfolders',true,...    
    'LabelSource','foldernames');
%imdsTest = imageDatastore('./SVM/slingshot/test');   
...
slingshot_classifer = fitcsvm(featuresTrain,trainLabels);   
...
% end    
save('slingshot_svmModel','slingshot_classifer');
